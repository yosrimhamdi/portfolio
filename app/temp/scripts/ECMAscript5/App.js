...
!function (e) {
  ...
  !function (t, n) {
    ...
    function (e) {
      ...
      try {
        q.apply(P = O.call(w.childNodes), w.childNodes), P[w.childNodes.length].nodeType;
      } catch (e) {
        q = {
        ...
        return i && !i[x] && (i = Te(i)), r && !r[x] && (r = Te(r, o)), ce(function (o, s, a, l) {
          ...
          if (o) {
            if (r || e) {
              ...
              for (u = y.length; u--;) {
                (p = y[u]) && (c = r ? L(o, p) : f[u]) > -1 && (o[c] = !(s[c] = p));
              }
            }
    ...
    T.fn.extend({
      ...
      T.fn[e] = function (n, i) {
        ...
        return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = T.filter(i, r)), this.length > 1 && (M[e] || T.uniqueSort(r), L.test(e) && r.reverse()), this.pushStack(r);
      };
    });
    var H = /[^\x20\t\r\n\f]+/g;
    ...
    T.event = {
      ...
      add: function add(e, t, n, i, r) {
        ...
        if (m) for (n.handler && (n = (o = n).handler, r = o.selector), r && T.find.matchesSelector(se, r), n.guid || (n.guid = T.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
          ...
          d = v = (a = Ae.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), d && (p = T.event.special[d] || {}, d = (r ? p.delegateType : p.bindType) || d, p = T.event.special[d] || {}, u = T.extend({
            type: d,
            origType: v,
            data: i,
            handler: n,
    ...
    function We(e, t, n, i) {
      ...
      var r,
          ...
          h = t[0],
          v = g(h);
      if (v || f > 1 && "string" == typeof h && !y.checkClone && Le.test(h)) return e.each(function (r) {
        var o = e.eq(r);
      ...
      trigger: function trigger(e, t, i, r) {
        ...
        if (a = d = l = i = i || s, 3 !== i.nodeType && 8 !== i.nodeType && !Ct.test(m + T.event.triggered) && (m.indexOf(".") > -1 && (y = m.split("."), m = y.shift(), y.sort()), u = m.indexOf(":") < 0 && "on" + m, (e = e[T.expando] ? e : new T.Event(m, "object" == _typeof(e) && e)).isTrigger = r ? 2 : 3, e.namespace = y.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + y.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), t = null == t ? [e] : T.makeArray(t, [e]), f = T.event.special[m] || {}, r || !f.trigger || !1 !== f.trigger.apply(i, t))) {
          ...
          for (o = 0; (a = v[o++]) && !e.isPropagationStopped();) {
            d = a, e.type = o > 1 ? c : f.bindType || m, (p = (K.get(a, "events") || {})[e.type] && K.get(a, "handle")) && p.apply(a, t), (p = u && a[u]) && p.apply && Y(a) && (e.result = p.apply(a, t), !1 === e.result && e.preventDefault());
          }
    ...
    Bt.href = St.href, T.extend({
      ...
      ajax: function ajax(e, t) {
        ...
        for (f in (p = T.event && h.global) && 0 == T.active++ && T.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Ht.test(h.type), r = h.url.replace(Lt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Ot, "+")) : (d = h.url.slice(r.length), h.data && (h.processData || "string" == typeof h.data) && (r += (Et.test(r) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (r = r.replace(Mt, "$1"), d = (Et.test(r) ? "&" : "?") + "_=" + At++ + d), h.url = r + d), h.ifModified && (T.lastModified[r] && C.setRequestHeader("If-Modified-Since", T.lastModified[r]), T.etag[r] && C.setRequestHeader("If-None-Match", T.etag[r])), (h.data && h.hasContent && !1 !== h.contentType || t.contentType) && C.setRequestHeader("Content-Type", h.contentType), C.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Wt + "; q=0.01" : "") : h.accepts["*"]), h.headers) {
    ...
    T.ajaxSetup({
      ...
      if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = g(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Qt, "$1" + r) : !1 !== e.jsonp && (e.url += (Et.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function () {
        return s || T.error(r + " was not called"), s[0];
      }, e.dataTypes[0] = "json", o = n[r], n[r] = function () {
        s = arguments;
      }, i.always(function () {
        void 0 === o ? T(n).removeProp(r) : n[r] = o, e[r] && (e.jsonpCallback = t.jsonpCallback, Yt.push(r)), s && g(o) && o(s[0]), s = o = void 0;
      }), "script";
  ...
  */
        ...
        this.elements.each(function (t, n) {
          new Waypoint({
            ...
            handler: function handler() {
              r()(n).addClass("".concat(e.animationClass, "--is-active")), setTimeout(Waypoint.refreshAll, 1);
            },
            offset: e.offset
          });
        });
  ...
  function () {
    function s() {
      ...
      this.elements = r()(".news__box"), this.setInitialClass(), this.setWaypoints();
    }
    ...
    _createClass(u, [{
      ...
      value: function event() {
        ...
        this.button.click(function (t) {
          if (e.getUserData(), Object(l.validate)(e.userInfo.to_email) && e.userInfo.to_name) return e.button.text("submitting..."), e.sendMailToUser(), e.sendMailToMe(), e.clearInput(), !1;
        });
      }
    }, {
      key: "getUserData",
      ...
      value: function sendMailToUser() {
        ...
        c.init(this.emailjs.userId), c.send(this.emailjs.service_id, this.emailjs.template_id, this.userInfo).then(function () {
      ...
      value: function sendMailToMe() {
        c.send(this.emailjs.service_id, this.emailjs.template_id_me, this.userInfo);
      }
    }]);
  ...
  new d(), particlesJS.load("particles-js", "/particles/particles.json", function () {
    ...
    backSpeed: 20,
    smartBackspace: !0
  }), new u(), new a(), new s(), new o(r()(".top-row"), "60%", "slideToLeftOnScroll"), new o(r()(".bottom-row"), "60%", "slideToRightOnScroll"), new o(r()(".form__group--name"), "60%", "slideToRightOnScroll"), new o(r()(".form__group--email"), "60%", "slideToLeftOnScroll"), new o(r()(".form__button"), "60%", "slideToRightOnScroll");
}]);